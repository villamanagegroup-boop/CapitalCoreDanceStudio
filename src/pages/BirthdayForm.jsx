...
const UPGRADES = [
  'Additional Children (over 10) – $15',
  'Extended Party Time (15 minutes) – $30',
  'Custom Theme Request – $25',
  'Glow Dance Party – $40',
  'Balloon Backdrop or Photo Area – $50',
  'Extra Themed Decorations – $30',
  'Personalized Party Playlist – $20',
  'Photo or Video Highlight (short clip) – $35',
  'Custom Birthday Sign with Child\'s Name – $20',
  'Party Favors Provided by Studio & Craft Station – $8/child',
...
export default function BirthdayForm() {
  ...
  async function handleSubmit(e) {
    ...
    const { error } = await supabase.from('birthday_bookings').insert([{
      ...
      optional_upgrades: form.upgrades.length ? form.upgrades.join(', ') : null,
          ...
          <form className="flex flex-col gap-8" onSubmit={handleSubmit} aria-label="Birthday party booking form">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className={fieldClass}>
                <label className={labelClass} htmlFor="parentName">Parent / Guardian Full Name</label>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className={`${fieldClass} flex-1`}>
                  <label className={labelClass} htmlFor="birthdayName">Birthday Person's Name</label>
                ...
                <div className={`${fieldClass} flex-1`}>
                  <label className={labelClass} htmlFor="birthdayAge">Upcoming Age</label>
              ...
              <div className={fieldClass}>
                <span className={labelClass}>Currently enrolled at Capital Core Dance Studio?</span>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className={`${fieldClass} flex-1`}>
                  <label className={labelClass} htmlFor="dateFirst">First Choice Party Date</label>
                  <input id="dateFirst" type="date" required value={form.dateFirst} onChange={handleChange} className={inputClass} />
                </div>
                <div className={`${fieldClass} flex-1`}>
                  <label className={labelClass} htmlFor="dateSecond">Second Choice Party Date</label>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className={fieldClass}>
                <label className={labelClass} htmlFor="guestCount">Estimated Number of Party Guests</label>
              ...
              <div className={fieldClass}>
                <span className={labelClass}>Theme Selection</span>
                <div className="flex flex-col gap-2 mt-1">
                  {THEMES.map((theme) => (
              ...
              <div className={fieldClass}>
                <span className={labelClass}>Will you be bringing food or cake?</span>
                <div className="flex gap-6 mt-1">
                  {['Yes', 'No'].map((opt) => (
                    <label key={opt} className={radioClass}>
              ...
              <div className={fieldClass}>
                <label className={labelClass} htmlFor="allergies">Any known allergies we should be aware of?</label>
